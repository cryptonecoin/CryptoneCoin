...
"""Verify that starting cryptonecoin with -h works as expected."""

from test_framework.test_framework import CryptonecoinTestFramework
from test_framework.util import assert_equal

class HelpTest(CryptonecoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cryptonecoin with -h for help text")
        ...
        self.log.info("Start cryptonecoin with -version for version information")
        ...
        self.log.info("Start cryptonecoind with -fakearg to make sure it does not start")
