...
class P2PPermissionsTests(CryptonecoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].cryptonecoinconf, encoding="utf8") as f:
            newText=f.read().replace(old, new)
        with open(self.nodes[nodeid].cryptonecoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
