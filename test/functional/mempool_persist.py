#!/usr/bin/env python3
# Copyright (c) 2014-2018 The Cryptonecoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test mempool persistence.

By default, cryptonecoind will dump mempool on shutdown and
...
class MempoolPersistTest(CryptonecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent cryptonecoind from writing mempool.dat to disk. Verify that `savemempool` fails")
