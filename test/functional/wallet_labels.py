#!/usr/bin/env python3
# Copyright (c) 2016-2018 The Cryptonecoin Core developers
...
class WalletLabelsTest(CryptonecoinTestFramework):
    ...
    def run_test(self):
        ...
        # each with 1 address with a balance of 50 Cryptonecoins
